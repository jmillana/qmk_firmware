...
KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              ES_QUOT,           \
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_G,              KC_M,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      KC_C,              KC_D,              KC_V,              KC_K,              KC_H,              KC_COMM,           ALGR_T(KC_DOT),    ES_SLSH,\
...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              ES_PERC,           KC_7,              KC_8,              KC_9,              ES_CIRC,           \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              ES_EQL,            KC_4,              KC_5,              KC_6,              ES_DQUO,           \
U_NA,              KC_ALGR,           TD(U_TD_U_NAV),    TD(U_TD_U_NUM),    U_NA,              ES_PLUS,           KC_1,              KC_2,              KC_3,              ES_QUOT,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              ES_MINS,           KC_0,              KC_DOT,            U_NP,              U_NP
...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              ES_LCBR,           ES_HASH,           ES_AT,           ES_TILD,           ES_RCBR,           \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              ES_LBRC,           ES_AMPR,           ES_AST,          ES_PIPE,           ES_RBRC,           \
U_NA,              KC_ALGR,           TD(U_TD_U_MOUSE),  TD(U_TD_U_SYM),    U_NA,              ES_LPRN,           ES_EXLM,           ES_DLR,          ES_BSLS,           ES_RPRN,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              ES_LABK,           ES_GRV,            ES_ACUT,         U_NP,              U_NP
